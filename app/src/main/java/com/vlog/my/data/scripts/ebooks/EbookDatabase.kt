...
import com.vlog.my.data.scripts.SubScripts // Ensure this import is correct

@Database(
    entities = [Ebook::class, Chapter::class, Bookmark::class, FontSetting::class, SubScripts::class], // Added SubScripts::class
    version = 1,
